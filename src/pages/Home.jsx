...
const Home = () => {
  ...
  return (
    <div className="container-fluid">
      <div
        className="container-fluid fixed-top d-flex flex-column justify-content-center align-items-center text-white mt-5"
          ...
          >
            <div className="input-group mb-3 w-100">
              <span
                ...
                style={{ background: "#0E162C", border: "none" }}
              >
      ...
      <div className="row d-flex justify-content-center">
        {[
          ...
          <div
            key={index}
            className="col-3 d-flex flex-column align-items-center mb-n1"
          >
