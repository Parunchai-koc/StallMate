  ...
  return (
    <div className="container d-flex flex-column justify-content-center align-items-center vh-100 p-0 m-0">
      <img
        src={loginpic}
        alt=""
        className="img-fluid my-4 mx-auto d-flex"
        style={{ width: "80vw", height: "70vw" }}
      />
      <p
        className="display-1 text-white my-4 font-weight-login"
        style={{ fontSize: "8vw" }}
      >
        Let’s You In
      </p>
      <div className="card-body d-flex flex-column">
        ...
        <div className="d-flex align-items-center text-center mb-3 text-white">
          <hr
            className="flex-fill"
            style={{ borderColor: "white", height: "0.2vw" }}
          />
          <span className="mx-2" style={{ fontSize: "3vw" }}>
            or
          </span>
          <hr
            className="flex-fill"
        ...
        <div className="text-center">
          <p className="text-white" style={{ fontSize: "3vw" }}>
            Create an account {" > "}
