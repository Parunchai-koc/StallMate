  ...
  return (
    <div className="container d-flex flex-column justify-content-center align-items-center vh-100 w-100">
      <img
        ...
        style={{ width: "58.7vw", height: "54.4vw" }}
      />
      <p
        className="display-4 text-white my-4 font-weight-login text-center"
        style={{ fontSize: "7vw" }}
      >
      ...
      <div className="container d-flex justify-content-center align-items-center mt-1">
        <button
          className="btn btn-custom-signup mb-4 mx-4"
          onClick={handleLogin}
        >
          <img
            src={fblogo}
            alt=""
            style={{ height: "7vw", width: "7vw", alignItems: "center" }}
          />
        </button>
        <button
          className="btn btn-custom-signup mb-4 mx-4"
      ...
      <div className="text-center">
        <p className="text-white" style={{ fontSize: "3.5vw" }}>
